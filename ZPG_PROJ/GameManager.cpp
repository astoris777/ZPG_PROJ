...
void GameManager::spawnShrek()
{
    ...
    std::vector<SubMesh> shrekSubmeshes = Model::loadWithMaterials("shrek.obj", shrekMaterials);
...
void GameManager::spawnFiona()
{
    ...
    std::vector<SubMesh> fionaSubmeshes = Model::loadWithMaterials("fiona.obj", fionaMaterials);
